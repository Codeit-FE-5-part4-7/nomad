...
function FloatingBox() {
  ...
  return (
    <div className='w-[38.4rem] h-[78rem] bg-white border-[0.2rem] border-gray-50 shadow-lg rounded-[0.8rem] p-[1rem]'>
      <div className='px-[2.4rem]'>
        <div className='flex items-center gap-[0.8rem] mb-[1.6rem]'>
          <p className='text-nomad-black text-[2.8rem] font-bold'>₩ 1,000</p>
        ...
        <div className='flex justify-between my-[1.8rem]'>
          ...
          <p className='text-nomad-black text-[2rem] font-bold'>₩ 1,000</p>
        </div>
      </div>
    </div>
  );
